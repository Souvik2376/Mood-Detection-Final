...
#     query_list.append(query_asis)
    ...
    if query_sentiments[0][0]>0.5:
        return render_template('index.html', prediction_text=f"Positive Statement ")
    else:
        return render_template('index.html', prediction_text=f"Negative Statement ")
